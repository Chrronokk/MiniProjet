...
HD_PWD='/cime-fmr/rollandl-fmr/xilinx/zedboard/emiss_recep_rs232_bram/vivado_2017_4/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emiss_recep_rs232_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source emiss_recep_rs232_bram.tcl
